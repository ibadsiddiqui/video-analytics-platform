        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            ...
            <p className="text-lg text-slate-600">
              Follow these step-by-step instructions to get your own YouTube
              Data API v3 key from Google Cloud Platform.
            </p>
          </motion.div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="text-sm text-amber-800 space-y-1">
                  <li>
                    • The YouTube Data API has a quota limit of 10,000 units per
                    day (free tier)
                  </li>
                  <li>
                  ...
                  <li>
                    • You can monitor your quota usage in the Google Cloud
                    Console
                  </li>
                </ul>
              </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="text-sm text-blue-800 space-y-1">
                  <li>
                    • Always restrict your API key to only the YouTube Data API
                    v3
                  </li>
                  <li>
                    • Add HTTP referrer restrictions if using in a web
                    application
                  </li>
          ...
          >
            ...
            <div className="space-y-3 text-sm text-slate-700">
              <p>
                The YouTube Data API v3 uses a quota system to limit API usage.
                Each request consumes a certain number of quota units:
              </p>
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li>
                  <strong>Video details:</strong> ~3 units per request
                </li>
                <li>
                  <strong>Channel details:</strong> ~3 units per request
                </li>
                <li>
                  <strong>Comments:</strong> ~1 unit per request
                </li>
                <li>
                  <strong>Total per analysis:</strong> ~10-15 units (depending
                  on features used)
                </li>
              </ul>
              <p className="mt-4">
                With the free tier quota of 10,000 units per day, you can
                analyze approximately <strong>600-1000 videos per day</strong>.
              </p>
              <p className="mt-2">
            ...
            <div className="space-y-4 text-sm text-slate-700">
              ...
              <div>
                ...
                <p>
                  ...
                  API key restrictions in the credentials page and ensure
