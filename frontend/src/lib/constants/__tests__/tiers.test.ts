...
describe('Tier Access System', () => {
  ...
  describe('hasFeatureAccess', () => {
    ...
    it('should return true for CREATOR tier on API_KEY_MANAGEMENT', () => {
      expect(hasFeatureAccess(UserTier.CREATOR, 'API_KEY_MANAGEMENT')).toBe(true);
    });
    ...
    it('should return true for AGENCY tier on all features', () => {
      expect(hasFeatureAccess(UserTier.AGENCY, 'API_KEY_MANAGEMENT')).toBe(true);
      expect(hasFeatureAccess(UserTier.AGENCY, 'VIRAL_SCORE')).toBe(true);
      expect(hasFeatureAccess(UserTier.AGENCY, 'AUDIENCE_ANALYTICS')).toBe(true);
    });
  });
